...
declare module 'vue-router/auto/routes' {
  export interface RouteNamedMap {
    ...
    '/components/layouts/MyChat': RouteRecordInfo<'/components/layouts/MyChat', '/components/layouts/MyChat', Record<never, never>, Record<never, never>>,
    '/components/layouts/MyFooter': RouteRecordInfo<'/components/layouts/MyFooter', '/components/layouts/MyFooter', Record<never, never>, Record<never, never>>,
    '/components/layouts/MyHeader': RouteRecordInfo<'/components/layouts/MyHeader', '/components/layouts/MyHeader', Record<never, never>, Record<never, never>>,
    '/components/MyTopSellers': RouteRecordInfo<'/components/MyTopSellers', '/components/MyTopSellers', Record<never, never>, Record<never, never>>,
    ...
    '/del_blog/': RouteRecordInfo<'/del_blog/', '/del_blog/', Record<never, never>, Record<never, never>>,
    '/del_blog/[slug]': RouteRecordInfo<'/del_blog/[slug]', '/del_blog/:slug', { slug: ParamValue<true> }, { slug: ParamValue<false> }>,
    '/del_wizard-v1/': RouteRecordInfo<'/del_wizard-v1/', '/del_wizard-v1/', Record<never, never>, Record<never, never>>,
    '/del_wizard-v1/project-details': RouteRecordInfo<'/del_wizard-v1/project-details', '/del_wizard-v1/project-details', Record<never, never>, Record<never, never>>,
    '/del_wizard-v1/project-files': RouteRecordInfo<'/del_wizard-v1/project-files', '/del_wizard-v1/project-files', Record<never, never>, Record<never, never>>,
    '/del_wizard-v1/project-info': RouteRecordInfo<'/del_wizard-v1/project-info', '/del_wizard-v1/project-info', Record<never, never>, Record<never, never>>,
    '/del_wizard-v1/project-review': RouteRecordInfo<'/del_wizard-v1/project-review', '/del_wizard-v1/project-review', Record<never, never>, Record<never, never>>,
    '/del_wizard-v1/project-team': RouteRecordInfo<'/del_wizard-v1/project-team', '/del_wizard-v1/project-team', Record<never, never>, Record<never, never>>,
    '/del_wizard-v1/project-tools': RouteRecordInfo<'/del_wizard-v1/project-tools', '/del_wizard-v1/project-tools', Record<never, never>, Record<never, never>>,
    '/del_wizard-v1/success': RouteRecordInfo<'/del_wizard-v1/success', '/del_wizard-v1/success', Record<never, never>, Record<never, never>>,
    ...
    '/views': RouteRecordInfo<'/views', '/views', Record<never, never>, Record<never, never>>,
    '/views/': RouteRecordInfo<'/views/', '/views/', Record<never, never>, Record<never, never>>,
    '/views/auth/login': RouteRecordInfo<'/views/auth/login', '/views/auth/login', Record<never, never>, Record<never, never>>,
    '/views/auth/signup': RouteRecordInfo<'/views/auth/signup', '/views/auth/signup', Record<never, never>, Record<never, never>>,
    '/views/MyCart': RouteRecordInfo<'/views/MyCart', '/views/MyCart', Record<never, never>, Record<never, never>>,
    '/views/MyCheckout': RouteRecordInfo<'/views/MyCheckout', '/views/MyCheckout', Record<never, never>, Record<never, never>>,
    '/views/MyDetail': RouteRecordInfo<'/views/MyDetail', '/views/MyDetail', Record<never, never>, Record<never, never>>,
    '/views/MyInfo': RouteRecordInfo<'/views/MyInfo', '/views/MyInfo', Record<never, never>, Record<never, never>>,
    '/views/MyMain': RouteRecordInfo<'/views/MyMain', '/views/MyMain', Record<never, never>, Record<never, never>>,
    '/views/MyOrders': RouteRecordInfo<'/views/MyOrders', '/views/MyOrders', Record<never, never>, Record<never, never>>,
    '/views/MyProduct': RouteRecordInfo<'/views/MyProduct', '/views/MyProduct', Record<never, never>, Record<never, never>>,
    '/views/MyShop/': RouteRecordInfo<'/views/MyShop/', '/views/MyShop/', Record<never, never>, Record<never, never>>,
