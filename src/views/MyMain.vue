              ...
              <div class="col-6 col-md-4 col-lg-3">
                ...
                <div class="card mb-7">
                  ...
                  <div class="card-body px-0">
                    ...
                    <!-- Category -->
                    <div class="fs-xs">
                      <a class="text-muted" href="MyShop">Shoes</a>
                    </div>
              ...
              <div class="col-6 col-md-4 col-lg-3">
                ...
                <div class="card mb-7">
                  ...
                  <div class="card-body px-0">
                    ...
                    <!-- Category -->
                    <div class="fs-xs">
                      <a class="text-muted" href="MyShop">Dresses</a>
                    </div>
              ...
              <div class="col-6 col-md-4 col-lg-3">
                ...
                <div class="card mb-7">
                  ...
                  <div class="card-body px-0">
                    ...
                    <!-- Category -->
                    <div class="fs-xs">
                      <a class="text-muted" href="MyShop">Tops</a>
                    </div>
              ...
              <div class="col-6 col-md-4 col-lg-3">
                ...
                <div class="card mb-7">
                  ...
                  <div class="card-body px-0">
                    ...
                    <!-- Category -->
                    <div class="fs-xs">
                      <a class="text-muted" href="MyShop">Bags</a>
                    </div>
              ...
              <div class="col-6 col-md-4 col-lg-3">
                ...
                <div class="card mb-7">
                  ...
                  <div class="card-body px-0">
                    ...
                    <!-- Category -->
                    <div class="fs-xs">
                      <a class="text-muted" href="MyShop">Skirts</a>
                    </div>
                  ...
                  <div class="card-body">
                    ...
                    <div class="row align-items-center mb-6">
                      ...
                      <div class="col-8 ms-n2">
                        ...
                        <!-- Preheading -->
                        <a class="fs-xs text-muted" href="MyShop">
                          Shoes
                        </a>
...
export default {
  ...
  methods: {
    async getProductList () {
      this.productList = await this.$api('/products', {})
