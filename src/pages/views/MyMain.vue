<template>
  ...
  <section>
    ...
    >
      <!-- Item -->
      <div
        class="col-12 col-md-6 col-lg-4 d-flex flex-column bg-cover"
        style="background-image: url(/assets/img/covers/cover-1.jpg)"
      >
        <div
          class="card bg-dark-5 bg-hover text-white text-center"
          style="min-height: 470px"
        >
          <div class="card-body mt-auto mb-n11 py-8">
            <!-- Heading -->
            <h1 class="mb-0 fw-bolder" style="font-size: 50px; color: white">Women</h1>
          </div>
      ...
      <div
        class="col-12 col-md-6 col-lg-4 d-flex flex-column bg-cover"
        style="background-image: url(/assets/img/covers/cover-2.jpg)"
      >
        <div
          class="card bg-dark-5 bg-hover text-white text-center"
          style="min-height: 470px"
        >
          <div class="card-body mt-auto mb-n11 py-8">
            <!-- Heading -->
            <h1 class="mb-0 fw-bolder" style="font-size: 50px; color: white">Men</h1>
          </div>
          <div class="card-body mt-auto py-8">
            <!-- Button -->
            <a class="btn btn-white stretched-link" href="MyShop">
      ...
      >
        ...
        >
          <div class="card-body mt-auto mb-n11 py-8">
            <!-- Heading -->
            <h1 class="mb-0 fw-bolder" style="font-size: 50px; color: white">
              Accessories
            </h1>
          </div>
          <div class="card-body mt-auto py-8">
            <!-- Button -->
            <a class="btn btn-white stretched-link" href="MyShop">
              Shop Accessories <i class="fe fe-arrow-right ms-2"></i>
            </a>
          </div>
        </div>
      </div>
    ...
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-12 col-md-10 col-lg-8 col-xl-6 text-center">
          <!-- Preheading -->
          <h6 class="heading-xxs mb-3 text-gray-400">New Collection</h6>

          <!-- Heading -->
          <h2 class="mb-4" style="font-size: 50px">Best Picks 2022</h2>

          <!-- Subheading -->
          <p class="mb-10 text-gray-500">
            Appear, dry there darkness they're seas, dry waters thing fly midst. Beast,
            above fly brought Very green.
          </p>
        </div>
      </div>
      <div class="row">
        <div class="col-12 col-md-5 col-lg-4 d-flex flex-column">
          <!-- Card -->
          <div
            class="card mb-7 text-white"
            style="
              min-height: 400px;
              background-image: url(/assets/img/products/product-1.jpg);
            "
          >
            <!-- Background -->
            <div class="card-bg">
              <div
                ...
                style="background-image: url(/assets/img/products/product-1.jpg)"
              ></div>
            </div>
            ...
            <div class="card-body my-auto text-center">
              <!-- Heading -->
              <h4 class="mb-0" style="font-size: 30px">Bags Collection</h4>

              <!-- Link -->
              <a class="btn btn-link stretched-link text-reset" href="MyShop">
        ...
        <div class="col-12 col-md-7 col-lg-8 d-flex flex-column">
          ...
          <div class="card mb-7 text-body" style="min-height: 400px">
            ...
            <div class="card-bg">
              <div
                class="card-bg-img bg-cover"
                style="background-image: url(/assets/img/products/product-2.jpg)"
              ></div>
            </div>
            ...
            <div class="card-body my-auto px-md-10 text-center text-md-start">
              ...
              <!-- Heading -->
              <h4 class="mb-0" style="font-size: 30px">Printed men’s Shirts</h4>

              <!-- Link -->
              <a class="btn btn-link stretched-link px-0 text-reset" href="MyShop">
                Shop Now <i class="fe fe-arrow-right ms-2"></i>
              </a>
            </div>
          </div>
        ...
        <div class="col-12 col-md-7 col-lg-8 d-flex flex-column">
          ...
          <div class="card mb-7 mb-md-0 text-body" style="min-height: 400px">
            ...
            <div class="card-bg">
              <div
                class="card-bg-img bg-cover"
                style="background-image: url(/assets/img/products/product-3.jpg)"
              ></div>
            </div>
            ...
            <div class="card-body my-auto px-md-10 text-center text-md-start">
              <!-- Heading -->
              <h4 class="mb-0" style="font-size: 30px">Basic women’s Dresses</h4>
        ...
        <div class="col-12 col-md-5 col-lg-4 d-flex flex-column">
          ...
          <div class="card text-white" style="min-height: 400px">
            ...
            <div class="card-bg">
              <div
                class="card-bg-img bg-cover"
                style="background-image: url(/assets/img/products/product-4.jpg)"
              ></div>
            </div>
            ...
            <div class="card-body my-auto text-center">
              <!-- Heading -->
              <h4 class="mb-0" style="font-size: 30px">Sweatshirts</h4>
    ...
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-12 col-md-10 col-lg-8 col-xl-6">
          <!-- Heading -->
          <h2 class="mb-4 text-center" style="font-size: 30px; font-weight: bold">
            Top month Sellers
          </h2>

          <!-- Nav -->
          <div class="nav justify-content-center mb-10">
            <a class="nav-link active" href="#topSellersTab" data-bs-toggle="tab"
              >Women</a
            >
      ...
      <div class="tab-content" style="display: block">
        <div id="topSellersTab" class="tab-pane fade show active">
          <div class="row">
            <div
    ...
    <div class="container">
      <div class="row justify-content-end">
        <div class="col-12 col-md-8 col-lg-6">
          <!-- Heading -->
          <h3 class="mb-7">Get -50% from <br />Summer Collection</h3>
          ...
          <!-- Button -->
          <a class="btn btn-dark" href="MyShop">
            Shop Now <i class="fe fe-arrow-right ms-2"></i>
          </a>
        </div>
      </div>
                ...
                <div class="card-body">
                  ...
                  <div class="row align-items-center mb-6">
                    ...
                    <div class="col-8 ms-n2">
                      <!-- Preheading -->
                      <a class="fs-xs text-muted" href="MyShop"> Shoes </a>
              ...
              <div class="card-lg card border">
                <div class="card-body">
                  ...
                  <div class="row align-items-center mb-6">
                    ...
                    <div class="col-8 ms-n2">
                      <!-- Preheading -->
                      <a class="fs-xs text-muted" href="MyShop"> Dresses </a>
                  ...
                  <blockquote class="mb-0">
                    <p class="text-muted">
                      God every fill great replenish darkness unto. Very open. Likeness
                      their that light. Given under image to. Subdue of shall cattle day
                      fish form saw spirit and given stars, us you whales may, land, saw
                      fill unto.
                    </p>
                    <footer class="fs-xs text-muted">
                ...
                <div class="card-body">
                  ...
                  <div class="row align-items-center mb-6">
                    <div class="col-4">
                      <!-- Image -->
                      <img
                        src="./assets/img/products/product-15.jpg"
                        alt="..."
                        class="img-fluid"
                      />
                    </div>
                    <div class="col-8 ms-n2">
                      <!-- Preheading -->
                      <a class="fs-xs text-muted" href="MyShop"> T-shirts </a>
                  ...
                  <blockquote class="mb-0">
                    <p class="text-muted">
                      Fill his waters wherein signs likeness waters. Second light gathered
                      appear sixth fourth, seasons behold creeping female.
                    </p>
                    <footer class="fs-xs text-muted">
              ...
              <div class="card-lg card border">
                <div class="card-body">
                  ...
                  <div class="row align-items-center mb-6">
                    ...
                    <div class="col-8 ms-n2">
                      <!-- Preheading -->
                      <a class="fs-xs text-muted" href="MyShop"> Bags & Accessories </a>
                  ...
                  <blockquote class="mb-0">
                    <p class="text-muted">
                      God every fill great replenish darkness unto. Very open. Likeness
                      their that light. Given under image to. Subdue of shall cattle day
                      fish form saw spirit and given stars.
                    </p>
                    <footer class="fs-xs text-muted">
    ...
    <div class="container">
      ...
      <div class="row mx-n1 mb-10">
        <div class="col-6 col-sm-4 col-md px-1">
          ...
          <div class="card mb-2">
            ...
            <!-- Overlay -->
            <a
              class="card-img-overlay card-img-overlay-hover align-items-center bg-dark-40"
              href="blog-post.html"
            >
      ...
      <div class="row">
        <div class="col-4 col-sm-3 col-md text-center">
          <!-- Brand -->
          <img
            src="./assets/img/brands/gray-350/mango.svg"
            alt="..."
        ...
        <div class="col-4 col-sm-3 col-md text-center">
          <!-- Brand -->
          <img
            src="./assets/img/brands/gray-350/zara.svg"
            alt="..."
            class="img-fluid mb-7 mb-md-0"
          />
        </div>
        <div class="col-4 col-sm-3 col-md text-center">
          <!-- Brand -->
          <img
            src="./assets/img/brands/gray-350/reebok.svg"
            alt="..."
            class="img-fluid mb-7 mb-md-0"
          />
        </div>
        <div class="col-4 col-sm-3 col-md text-center">
          <!-- Brand -->
          <img
            src="./assets/img/brands/gray-350/asos.svg"
            alt="..."
            class="img-fluid mb-7 mb-md-0"
          />
        </div>
        <div class="col-4 col-sm-3 col-md text-center">
          <!-- Brand -->
          <img
            src="./assets/img/brands/gray-350/stradivarius.svg"
            alt="..."
        ...
        <div class="col-4 col-sm-3 col-md text-center">
          <!-- Brand -->
          <img
            src="./assets/img/brands/gray-350/adidas.svg"
            alt="..."
            class="img-fluid mb-6 mb-sm-0"
          />
        </div>
        <div class="col-4 col-sm-3 col-md text-center">
          <!-- Brand -->
          <img
            src="./assets/img/brands/gray-350/bershka.svg"
            alt="..."
            class="img-fluid"
          />
        </div>
