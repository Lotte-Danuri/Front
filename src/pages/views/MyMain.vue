    ...
    >
      ...
      >
        ...
        >
          <div class="card-body mt-auto mb-n11 py-8">
            <!-- Heading -->
            <h1 class="mb-0 fw-bolder">Women</h1>
          </div>
      ...
      >
        ...
        >
          <div class="card-body mt-auto mb-n11 py-8">
            <!-- Heading -->
            <h1 class="mb-0 fw-bolder">Men</h1>
          </div>
          <div class="card-body mt-auto py-8">
            <!-- Button -->
            <a class="btn btn-white stretched-link" href="MyShop">
      ...
      >
        ...
        >
          <div class="card-body mt-auto mb-n11 py-8">
            <!-- Heading -->
            <h1 class="mb-0 fw-bolder">Accessories</h1>
          </div>
          <div class="card-body mt-auto py-8">
            <!-- Button -->
            <a class="btn btn-white stretched-link" href="MyShop">
    ...
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-12 col-md-10 col-lg-8 col-xl-6 text-center">
          ...
          <!-- Heading -->
          <h2 class="mb-4">Best Picks 2022</h2>
...
<script>
import MyTopSellers from '../../components/MyTopSellers.vue'
export default {
  components: { MyTopSellers },
}
</script>
