        ...
        <div class="timeline-item">
          ...
          <div class="content-wrap">
            <div class="content-box">
              ...
              <div class="box-end">
                <VAvatar size="small" squared picture="https://vuero.cssninja.io/demo/photos/apps/5.png" />
                <VAvatar size="small" squared picture="https://vuero.cssninja.io/demo/photos/apps/8.png" />
              </div>
            </div>
          </div>
        </div>
