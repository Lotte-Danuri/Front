        ...
        <div class="grid-item">
          ...
          <div class="bottom-section">
            <div class="foot-block">
              <h4 class="heading">Developers</h4>
              <div class="developers">
                <VAvatar size="small" picture="https://vuero.cssninja.io/demo/avatars/25.jpg" />
              </div>
            </div>
            <div class="foot-block">
              <h4 class="heading">Deadline</h4>
        ...
        <div class="grid-item">
          ...
          <div class="bottom-section">
            <div class="foot-block">
              <h4 class="heading">Developers</h4>
              <div class="developers">
                <VAvatar size="small" picture="https://vuero.cssninja.io/demo/avatars/12.jpg" />
              </div>
            </div>
            <div class="foot-block">
              <h4 class="heading">Deadline</h4>
        ...
        <div class="grid-item">
          ...
          <div class="bottom-section">
            <div class="foot-block">
              <h4 class="heading">Developers</h4>
              <div class="developers">
                <VAvatar size="small" picture="https://vuero.cssninja.io/demo/avatars/24.jpg" />
                <VAvatar size="small" picture="https://vuero.cssninja.io/demo/avatars/18.jpg" />
                <VAvatar size="small" picture="https://vuero.cssninja.io/demo/avatars/16.jpg" />
              </div>
            </div>
            <div class="foot-block">
              <h4 class="heading">Deadline</h4>
