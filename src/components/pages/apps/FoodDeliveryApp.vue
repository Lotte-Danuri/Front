      ...
      <div class="sticky-panel fixed-child">
        ...
        >
          ...
          <div class="cart-items has-slimscroll is-hidden">
            <div class="cart-item">
              <VAvatar picture="https://vuero.cssninja.io/demo/photos/food/1.jpg" size="medium" squared />
              <div class="meta">
            ...
            <div class="cart-item">
              <VAvatar picture="https://vuero.cssninja.io/demo/photos/food/2.jpg" size="medium" squared />
              <div class="meta">
            ...
            <div class="cart-item">
              <VAvatar picture="https://vuero.cssninja.io/demo/photos/food/3.jpg" size="medium" squared />
              <div class="meta">
