            ...
            <div class="dashboard-list">
              ...
              <div class="inner-list">
                <VBlock title="Extreme Foot Trekk" subtitle="Oct 31, 2020" center>
                  <template #icon>
                    <VAvatar picture="https://vuero.cssninja.io/demo/photos/dashboards/lifestyle/1.jpg" squared />
                  </template>
                  <template #action>
                    <div class="rating">
                ...
                <VBlock title="Rafting trip" subtitle="Oct 30, 2020" center>
                  <template #icon>
                    <VAvatar picture="https://vuero.cssninja.io/demo/photos/dashboards/lifestyle/2.jpg" squared />
                  </template>
                  <template #action>
                    <div class="rating">
                      <i aria-hidden="true" class="fas fa-star selected"></i>
                ...
                <VBlock title="Climbing Group [Pro]" subtitle="Oct 31, 2020" center>
                  <template #icon>
                    <VAvatar picture="https://vuero.cssninja.io/demo/photos/dashboards/lifestyle/3.jpg" squared />
                  </template>
                  <template #action>
                    <div class="rating">
                      <i aria-hidden="true" class="fas fa-star selected"></i>
                ...
                <VBlock title="Bicycle Madness Trek" subtitle="Oct 31, 2020" center>
                  <template #icon>
                    <VAvatar picture="https://vuero.cssninja.io/demo/photos/dashboards/lifestyle/4.jpg" squared />
                  </template>
                  <template #action>
                    <div class="rating">
                      <i aria-hidden="true" class="fas fa-star selected"></i>
            ...
            <div class="dashboard-list">
              ...
              <div class="inner-list">
                <VBlock title="Extreme Triathlon" subtitle="Nov 2, 2020" center>
                  <template #icon>
                    <VAvatar picture="https://vuero.cssninja.io/demo/photos/dashboards/lifestyle/5.jpg" squared />
                  </template>
                  <template #action>
                    <div class="rating">
                      <i aria-hidden="true" class="fas fa-star selected"></i>
                ...
                <VBlock title="Group Running" subtitle="Oct 29, 2020" center>
                  <template #icon>
                    <VAvatar picture="https://vuero.cssninja.io/demo/photos/dashboards/lifestyle/6.jpg" squared />
                  </template>
                  <template #action>
                    <div class="rating">
                      <i aria-hidden="true" class="fas fa-star selected"></i>
                ...
                <VBlock title="Suit Diving" subtitle="Oct 28, 2020" center>
                  <template #icon>
                    <VAvatar picture="https://vuero.cssninja.io/demo/photos/dashboards/lifestyle/7.jpg" squared />
                  </template>
                  <template #action>
                    <div class="rating">
                      <i aria-hidden="true" class="fas fa-star selected"></i>
